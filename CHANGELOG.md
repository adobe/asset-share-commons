...
## [asset-share-commons-3.13.8](https://github.com/adobe/asset-share-commons/tree/asset-share-commons-3.13.8)

[Full Changelog](https://github.com/adobe/asset-share-commons/compare/assetshare-2.3.0...asset-share-commons-3.13.8)
...
- Fix #1370 - Use principal-based ACL for asset-share-commons-mimetype-… [#1375](https://github.com/adobe/asset-share-commons/pull/1375) (davidjgonzalez)
- Fix CWE-113: strip CR/LF from values written into HTTP response headers [#1376](https://github.com/adobe/asset-share-commons/pull/1376) (davidjgonzalez)
...
- Generated unite tests with Claude [#1378](https://github.com/adobe/asset-share-commons/pull/1378) (davidjgonzalez)
- Added new AEM Logo to share email [#1377](https://github.com/adobe/asset-share-commons/pull/1377) (davidjgonzalez)
- Bump org.apache.maven.plugins:maven-compiler-plugin from 3.14.1 to 3.15.0 [#1367](https://github.com/adobe/asset-share-commons/pull/1367) (dependabot[bot])
- Bump org.apache.maven.plugins:maven-enforcer-plugin from 3.5.0 to 3.6.3 [#1368](https://github.com/adobe/asset-share-commons/pull/1368) (dependabot[bot])
- Bump actions/checkout from 6 to 7 [#1369](https://github.com/adobe/asset-share-commons/pull/1369) (dependabot[bot])
- Bump org.slf4j:slf4j-simple from 2.0.13 to 2.0.18 [#1357](https://github.com/adobe/asset-share-commons/pull/1357) (dependabot[bot])
- Bump codecov/codecov-action from 6 to 7 [#1366](https://github.com/adobe/asset-share-commons/pull/1366) (dependabot[bot])
- Updated Snapshot Deploy github action so i can ensure the credentials… [#1353](https://github.com/adobe/asset-share-commons/pull/1353) (davidjgonzalez)
- v3.12.2 release [#1352](https://github.com/adobe/asset-share-commons/pull/1352) (davidjgonzalez)
- Bump org.codehaus.mojo:build-helper-maven-plugin from 3.6.0 to 3.6.1 [#1344](https://github.com/adobe/asset-share-commons/pull/1344) (dependabot[bot])
- Bump org.apache.maven.plugins:maven-dependency-plugin from 3.8.1 to 3.10.0 [#1343](https://github.com/adobe/asset-share-commons/pull/1343) (dependabot[bot])
- Bump org.apache.maven.plugins:maven-pmd-plugin from 3.25.0 to 3.28.0 [#1342](https://github.com/adobe/asset-share-commons/pull/1342) (dependabot[bot])
- Bump org.apache.maven.plugins:maven-clean-plugin from 3.3.2 to 3.5.0 [#1345](https://github.com/adobe/asset-share-commons/pull/1345) (dependabot[bot])
- Fix race condition in AiFulltextPredicateEvaluatorTest [#1348](https://github.com/adobe/asset-share-commons/pull/1348) (sayanc82)
- Bump codecov/codecov-action from 5 to 6 [#1347](https://github.com/adobe/asset-share-commons/pull/1347) (dependabot[bot])
- Bump softprops/action-gh-release from 2 to 3 [#1349](https://github.com/adobe/asset-share-commons/pull/1349) (dependabot[bot])
- fixed upperbound value to use initialupperbound instead of lowerbound [#1350](https://github.com/adobe/asset-share-commons/pull/1350) (Shiffali)
- v3.13.4 - Maven central deployment release fixes [#1341](https://github.com/adobe/asset-share-commons/pull/1341) (davidjgonzalez)
- v3.13.4 - Release fixes [#1340](https://github.com/adobe/asset-share-commons/pull/1340) (davidjgonzalez)
- v3.13.4 [#1339](https://github.com/adobe/asset-share-commons/pull/1339) (davidjgonzalez)
- Maven central publishing updates [#1338](https://github.com/adobe/asset-share-commons/pull/1338) (davidjgonzalez)
- v3.13.2 release [#1336](https://github.com/adobe/asset-share-commons/pull/1336) (davidjgonzalez)
- Updated to Central from ossrh [#1337](https://github.com/adobe/asset-share-commons/pull/1337) (davidjgonzalez)
- Bump org.mockito:mockito-core from 5.16.1 to 5.21.0 [#1332](https://github.com/adobe/asset-share-commons/pull/1332) (dependabot[bot])
- Bump org.jacoco:jacoco-maven-plugin from 0.8.12 to 0.8.14 [#1330](https://github.com/adobe/asset-share-commons/pull/1330) (dependabot[bot])
- Bump org.apache.maven.plugins:maven-compiler-plugin from 3.14.0 to 3.14.1 [#1329](https://github.com/adobe/asset-share-commons/pull/1329) (dependabot[bot])
- Bump org.apache.maven.plugins:maven-resources-plugin from 3.3.1 to 3.4.0 [#1331](https://github.com/adobe/asset-share-commons/pull/1331) (dependabot[bot])
- Removed deprecated APIs [#1335](https://github.com/adobe/asset-share-commons/pull/1335) (davidjgonzalez)
- v3.13.0 release [#1328](https://github.com/adobe/asset-share-commons/pull/1328) (davidjgonzalez)
- Added Externalizer domain to Share configuration [#1327](https://github.com/adobe/asset-share-commons/pull/1327) (davidjgonzalez)
- Bump org.jacoco:jacoco-maven-plugin from 0.8.12 to 0.8.14 [#1321](https://github.com/adobe/asset-share-commons/pull/1321) (dependabot[bot])
- Bump org.apache.maven.plugins:maven-enforcer-plugin from 3.5.0 to 3.6.2 [#1322](https://github.com/adobe/asset-share-commons/pull/1322) (dependabot[bot])
- Bump org.apache.sling:org.apache.sling.testing.osgi-mock.junit4 from 3.5.2 to 3.5.4 [#1323](https://github.com/adobe/asset-share-commons/pull/1323) (dependabot[bot])
- feat: add i18n support for classification categories in asset details metadata [#1325](https://github.com/adobe/asset-share-commons/pull/1325) (tmastalirsch-tlv)
- fix: Audio component Sling Model binding and add MIME type support [#1324](https://github.com/adobe/asset-share-commons/pull/1324) (tmastalirsch-tlv)
- v3.12.0 release [#1318](https://github.com/adobe/asset-share-commons/pull/1318) (davidjgonzalez)
- Bump com.github.eirslett:frontend-maven-plugin from 1.14.2 to 1.15.4 [#1309](https://github.com/adobe/asset-share-commons/pull/1309) (dependabot[bot])
- Bump mikepenz/release-changelog-builder-action from 4 to 6 [#1312](https://github.com/adobe/asset-share-commons/pull/1312) (dependabot[bot])
- Bump actions/checkout from 5 to 6 [#1316](https://github.com/adobe/asset-share-commons/pull/1316) (dependabot[bot])
- feat: add Audio component with implementation and dialog configuration [#1317](https://github.com/adobe/asset-share-commons/pull/1317) (tmastalirsch-tlv)
...
- v3.10.14 [#1280](https://github.com/adobe/asset-share-commons/pull/1280) (davidjgonzalez)
...
## [asset-share-commons-3.13.6](https://github.com/adobe/asset-share-commons/tree/asset-share-commons-3.13.6)

[Full Changelog](https://github.com/adobe/asset-share-commons/compare/assetshare-2.3.0...asset-share-commons-3.13.6)
...
## [asset-share-commons-3.13.4](https://github.com/adobe/asset-share-commons/tree/asset-share-commons-3.13.4)

[Full Changelog](https://github.com/adobe/asset-share-commons/compare/assetshare-2.3.0...asset-share-commons-3.13.4)
...
## [asset-share-commons-3.13.2](https://github.com/adobe/asset-share-commons/tree/asset-share-commons-3.13.2)

[Full Changelog](https://github.com/adobe/asset-share-commons/compare/assetshare-2.3.0...asset-share-commons-3.13.2)
...
## [asset-share-commons-3.13.0](https://github.com/adobe/asset-share-commons/tree/asset-share-commons-3.13.0)

[Full Changelog](https://github.com/adobe/asset-share-commons/compare/assetshare-2.3.0...asset-share-commons-3.13.0)
...
## [asset-share-commons-3.12.2](https://github.com/adobe/asset-share-commons/tree/asset-share-commons-3.12.2)

[Full Changelog](https://github.com/adobe/asset-share-commons/compare/assetshare-2.3.0...asset-share-commons-3.12.2)
...
## [asset-share-commons-3.12.0](https://github.com/adobe/asset-share-commons/tree/asset-share-commons-3.12.0)

[Full Changelog](https://github.com/adobe/asset-share-commons/compare/assetshare-2.3.0...asset-share-commons-3.12.0)
