...
public class FileExtensionImplTest {
    ...
    public void setUp() throws Exception {
        ctx.registerInjectActivateService(new FileExtensionImpl());
        computedProperty = ctx.getService(ComputedProperty.class);
    }

    @Test
    public void getName() {
        assertEquals(FileExtensionImpl.NAME, computedProperty.getName());
    }

    @Test
    public void getLabel() {
        assertEquals(FileExtensionImpl.LABEL, computedProperty.getLabel());
    }
    ...
    @Test
    public void get_WithMultipleDots() {
        when(asset.getName()).thenReturn("test.final.png");
    ...
    @Test
    public void get_WithNoExtension() {
