...
public class AssetDownloadHelperImplTest {
	...
	public void setUp() throws Exception {
	    ...
	    Configuration[] myserviceconfigs = {assetDownloadConfig};
	    doReturn(myserviceconfigs).when(spyConfigurationAdmin).listConfigurations("(service.pid=" + ASSET_DOWNLOAD_SERVLET_PID + ")");
	...
	@Test
	public void testGetMaxContentSizeLimit_NullConfig() {
        long expected = -1;
